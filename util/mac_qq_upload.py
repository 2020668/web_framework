...
def qq3():
    ...
    # loc = By.XPATH, "//div[@class='tc-drag-track']"
    # loc = By.XPATH, "//div[@id='slideBgWrap']"
    WebDriverWait(driver, 20).until(ec.visibility_of_element_located(loc))
    ...
    # 由于无法精确滑到缺口那里 所以我们设置写一个循环 没有成功就继续减小一点距离 继续滑动
    x = 0
    i = 1
    while True:
